...
<template>
  <main>
    <div class="container-fluid px-4">
      ...
      >
        <div>
          <h5 class="mb-1">Quản lý thương hiệu</h5>

          <small class="text-muted">
            Trang này cho phép quản trị viên quản lý thương hiệu, bao gồm tìm
            kiếm, lọc và xem chi tiết thương hiệu một cách hiệu quả.
          </small>
        </div>
        <button class="btn btn-primary mt-2 mt-md-0">
          <i class="bi bi-person-plus me-1"></i> Tạo mới sản phẩm
        </button>
      </div>
